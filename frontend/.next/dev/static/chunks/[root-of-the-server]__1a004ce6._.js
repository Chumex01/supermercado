...
const setToken = (token)=>{
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].set(TOKEN_KEY, token, {
        expires: 1
    }); // 1 día
};
...
function LoginForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError("");
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["login"])({
                correo,
                contrasena
            });
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["setToken"])(res.data.access_token); // guarda JWT
            router.push("/home");
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a004ce6._.js.map